...
class AttendanceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('trainer.attendance.index',compact('att'));
    }
    ...
    public function create()
    {
        ...
        return view('trainer.attendance.create',compact('user','date'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($date){
            ...
            $request->session()->flash('success','Attendance done');
    ...
    public function edit($id)
    {
        ...
        ->where('roles.name','=','User')
        ->get();
        return view('trainer.attendance.edit', compact('user','id','aa','atdate'));
    }
