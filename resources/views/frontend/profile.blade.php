                    ...
                    <form method="POST" action="{{ route('user-profile-information.update') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="form-group col-md-6">
                                <select id="gender" class="form-control" name="gender" value="{{ auth()->user()->gender }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="address" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ auth()->user()->address }}" required autocomplete="address" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                    <input type="date" id="dob" class="form-control  @error('dob') is-invalid @enderror" value="{{ auth()->user()->dob }}" name="dob"  required autocomplete="dob" autofocus/>
                                @error('dob')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
