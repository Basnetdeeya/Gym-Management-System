                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('admin.plans.store') }}" enctype="multipart/form-data">
                                @csrf
                                <h3 class="text-center fw-bold pb-3">Packages</h3>
                                <div class=" mx-5 mb-3">
                                ...
                                <div class=" mx-5 mb-3">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" class="description form-control @error('facility') is-invalid @enderror" name="facility" rows="5"  autofocus></textarea>
