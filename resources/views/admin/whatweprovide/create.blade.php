        ...
        <div class="row">
            <div class="col-md 12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('admin.whatprovide.store') }}" enctype="multipart/form-data">
                                @csrf
                                <h3 class="text-center fw-bold pb-3">What We Provide</h3>

                                <div class=" mx-5 mb-3">
                                    <label for="serviceimage" class=" col-form-label text-md-end">{{ __('Image:') }}</label>

                                        <input id="serviceimage" type="file" class="form-control-file @error('serviceimage') is-invalid @enderror" name="serviceimage" value="{{ old('serviceimage') }}" autofocus>
