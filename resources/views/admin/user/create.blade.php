                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('admin.member.store') }}" enctype="multipart/form-data">
                                ...
                                <h3 class="text-center fw-bold pb-3">Add Member</h3>
                                ...
                                <div class="row mb-3 mx-5">
                                    ...
                                    <div class="col-md-10">
                                            <input type="text" id="dob" class="form-control date @error('dob') is-invalid @enderror date" name="dob"  required autocomplete="dob" autofocus/>
                                        @error('dob')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
