...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2{{url('/')}}/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2 text-white ">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="{{ route('admin.admindashboard.index') }}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.whatprovide.index') }}" class="nav-link">
                <i class="fa-solid fa-hand-holding-heart mx-3"></i>
              <p> What We Provide</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="{{ route('admin.schedule.index') }}" class="nav-link">
                <i class="fa-solid fa-calendar-plus mx-3"></i>
              <p>Schedule</p>
            </a>
          </li>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2{{url('/')}}/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
